/*
  # Fix Bitcoin address format and wallet creation

  1. Changes
    - Updates Bitcoin address format to use valid testnet addresses
    - Ensures proper address generation
    - Recreates wallets with valid addresses
...
AS $$
BEGIN
  -- Create Bitcoin testnet wallet (tb1 prefix for testnet)
  INSERT INTO wallets (user_id, blockchain, address, private_key)
  VALUES (
    NEW.id,
    'bitcoin',
    'tb1q' || substring(encode(gen_random_bytes(20), 'hex') from 1 for 38),
